...
public class Windo5 extends JFrame {
    //define variables
    private JPanel panel, panel3, panel2, panel4;
...
//build the image label panel to edit its properties
    private void bulidimagepanel() {
        ...
        //image messageLabel
        imagelabel = new JLabel(new ImageIcon("C:\\Users\\msi 1\\OneDrive\\سطح المكتب\\رنو\\killing.jpeg"));
...
//build the Text Area panel to edit its properties
    private void buildLabelPanel() {
        ...
        try {
            ...
            messageLabel = new JLabel("Game Over " + str +" you are died !");
